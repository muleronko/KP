...
(function ($) {
    var $mol_page = (function (_super) {
        ...
        $mol_page.prototype.control = function () {
            return [];
        };
        $mol_page.prototype.Control = function () {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
                obj.sub = function () { return _this.control(); };
            });
        };
        ...
        $mol_page.prototype.head = function () {
            return [].concat(this.Control(), this.Title(), this.Tools());
        };
        $mol_page.prototype.Head = function () {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
    ...
    __decorate([
        $.$mol_mem()
    ], $mol_page.prototype, "Control", null);
    __decorate([
        $.$mol_mem()
...
(function ($) {
    ...
    (function ($mol) {
        var $mol_page = (function (_super) {
            ...
            $mol_page.prototype.head = function () {
                return [
                    this.control().length > 0 ? this.Control() : null,
...
(function ($) {
    var $mol_text = (function (_super) {
        ...
        $mol_text.prototype.Span = function (id) {
            return new $.$mol_text_span();
        };
        $mol_text.prototype.Link = function (id) {
            return new $.$mol_text_link();
        };
        $mol_text.prototype.Image = function (id) {
            return new $.$mol_text_image();
        };
...
(function ($) {
    var $mol_http = (function (_super) {
        ...
        $mol_http.resource = function (uri) {
            var normal = new URL(uri, $.$mol_dom_context.document.location.href).toString();
            return this.resource_absolute(normal);
        };
        $mol_http.resource_absolute = function (uri) {
            var next = new $mol_http;
            next.uri = function () { return uri; };
            return next;
        };
...
(function ($) {
    var $mol_file = (function (_super) {
        ...
        $mol_file.absolute = function (path) {
            var next = new $mol_file();
            next.path = function () { return path; };
            return next;
        };
        $mol_file.relative = function (path) {
            var uri = new URL(path, $.$mol_dom_context.document.location.href);
...
var $;
(function ($) {
    var $saprun_stuff = (function (_super) {
        __extends($saprun_stuff, _super);
        function $saprun_stuff() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        $saprun_stuff.prototype.head = function () {
            return null;
        };
        $saprun_stuff.prototype.Body_singup = function () {
            return new $.$saprun_stuff_form_box();
        };
        $saprun_stuff.prototype.body = function () {
            return [].concat(this.Body_singup());
        };
        $saprun_stuff.prototype.foot = function () {
            return null;
        };
        return $saprun_stuff;
    }($.$mol_page));
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff.prototype, "Body_singup", null);
    $.$saprun_stuff = $saprun_stuff;
})($ || ($ = {}));
(function ($) {
    var $saprun_stuff_form_box = (function (_super) {
        __extends($saprun_stuff_form_box, _super);
        function $saprun_stuff_form_box() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        $saprun_stuff_form_box.prototype.Logo_main = function () {
            return new $.$mol_image().setup(function (obj) {
                obj.uri = function () { return "-/saprun/stuff/thumbs/logo.png"; };
            });
        };
        $saprun_stuff_form_box.prototype.name = function () {
            return "# Кадровый портал\nПравительства Ленинградской области";
        };
        $saprun_stuff_form_box.prototype.Logo_name = function () {
            var _this = this;
            return new $.$mol_text().setup(function (obj) {
                obj.text = function () { return _this.name(); };
            });
        };
        $saprun_stuff_form_box.prototype.table_id_label = function () {
            return $.$mol_locale.text(this.locale_contexts(), "table_id_label");
        };
        $saprun_stuff_form_box.prototype.table_id_errors = function () {
            return [];
        };
        $saprun_stuff_form_box.prototype.table_id_hint = function () {
            return "231456";
        };
        $saprun_stuff_form_box.prototype.table_id = function (val, force) {
            return (val !== void 0) ? val : "";
        };
        $saprun_stuff_form_box.prototype.Table_id_control = function () {
            var _this = this;
            return new $.$mol_string().setup(function (obj) {
                obj.hint = function () { return _this.table_id_hint(); };
                obj.value = function (val) { return _this.table_id(val); };
            });
        };
        $saprun_stuff_form_box.prototype.Table_id = function () {
            var _this = this;
            return new $.$mol_form_field().setup(function (obj) {
                obj.name = function () { return _this.table_id_label(); };
                obj.errors = function () { return _this.table_id_errors(); };
                obj.control = function () { return _this.Table_id_control(); };
            });
        };
        $saprun_stuff_form_box.prototype.password_label = function () {
            return $.$mol_locale.text(this.locale_contexts(), "password_label");
        };
        $saprun_stuff_form_box.prototype.password_errors = function () {
            return [];
        };
        $saprun_stuff_form_box.prototype.password_hint = function () {
            return "******";
        };
        $saprun_stuff_form_box.prototype.password = function (val, force) {
            return (val !== void 0) ? val : "";
        };
        $saprun_stuff_form_box.prototype.password_control = function () {
            var _this = this;
            return new $.$mol_string().setup(function (obj) {
                obj.hint = function () { return _this.password_hint(); };
                obj.value = function (val) { return _this.password(val); };
            });
        };
        $saprun_stuff_form_box.prototype.Password = function () {
            var _this = this;
            return new $.$mol_form_field().setup(function (obj) {
                obj.name = function () { return _this.password_label(); };
                obj.errors = function () { return _this.password_errors(); };
                obj.control = function () { return _this.password_control(); };
            });
        };
        $saprun_stuff_form_box.prototype.login_submit_label = function () {
            return $.$mol_locale.text(this.locale_contexts(), "login_submit_label");
        };
        $saprun_stuff_form_box.prototype.event_submit = function (val, force) {
            return (val !== void 0) ? val : null;
        };
        $saprun_stuff_form_box.prototype.Login_submit = function () {
            var _this = this;
            return new $.$mol_button_minor().setup(function (obj) {
                obj.title = function () { return _this.login_submit_label(); };
                obj.event_click = function (val) { return _this.event_submit(val); };
            });
        };
        $saprun_stuff_form_box.prototype.Form = function () {
            var _this = this;
            return new $.$mol_form().setup(function (obj) {
                obj.form_fields = function () { return [].concat(_this.Table_id(), _this.Password()); };
                obj.buttons = function () { return [].concat(_this.Login_submit()); };
            });
        };
        $saprun_stuff_form_box.prototype.Sign_up_form = function () {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.Form()); };
            });
        };
        $saprun_stuff_form_box.prototype.sub = function () {
            return [].concat(this.Logo_main(), this.Logo_name(), this.Sign_up_form());
        };
        return $saprun_stuff_form_box;
    }($.$mol_view));
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "Logo_main", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "Logo_name", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "table_id", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "Table_id_control", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "Table_id", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "password", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "password_control", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "Password", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "event_submit", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "Login_submit", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "Form", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_form_box.prototype, "Sign_up_form", null);
    $.$saprun_stuff_form_box = $saprun_stuff_form_box;
})($ || ($ = {}));
//stuff.view.tree.js.map
;
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var $;
(function ($) {
    var $saprun_stuff_bord = (function (_super) {
        __extends($saprun_stuff_bord, _super);
        function $saprun_stuff_bord() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        $saprun_stuff_bord.prototype.Head = function () {
            return new $.$saprun_stuff_bord_head();
        };
        $saprun_stuff_bord.prototype.head = function () {
            return [].concat(this.Head());
        };
        $saprun_stuff_bord.prototype.title_menu = function () {
            return "Документы";
        };
        $saprun_stuff_bord.prototype.Close_icon = function () {
            return new $.$mol_icon_cross();
        };
        $saprun_stuff_bord.prototype.Close = function () {
            var _this = this;
            return new $.$mol_link().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.Close_icon()); };
            });
        };
        $saprun_stuff_bord.prototype.menu_rows = function () {
            return [];
        };
        $saprun_stuff_bord.prototype.Menu = function () {
            var _this = this;
            return new $.$mol_list().setup(function (obj) {
                obj.rows = function () { return _this.menu_rows(); };
            });
        };
        $saprun_stuff_bord.prototype.Menu_page = function () {
            var _this = this;
            return new $.$mol_page().setup(function (obj) {
                obj.minimal_width = function () { return 300; };
                obj.title = function () { return _this.title_menu(); };
                obj.tools = function () { return [].concat(_this.Close()); };
                obj.body = function () { return [].concat(_this.Menu()); };
            });
        };
        $saprun_stuff_bord.prototype.title_bord = function () {
            return "Формуляры";
        };
        $saprun_stuff_bord.prototype.bord_rows = function () {
            return [];
        };
        $saprun_stuff_bord.prototype.Bord = function () {
            var _this = this;
            return new $.$mol_list().setup(function (obj) {
                obj.rows = function () { return _this.bord_rows(); };
            });
        };
        $saprun_stuff_bord.prototype.Bord_page = function () {
            var _this = this;
            return new $.$mol_page().setup(function (obj) {
                obj.minimal_width = function () { return 600; };
                obj.title = function () { return _this.title_bord(); };
                obj.body = function () { return [].concat(_this.Bord()); };
            });
        };
        $saprun_stuff_bord.prototype.Dashbord = function () {
            var _this = this;
            return new $.$mol_book().setup(function (obj) {
                obj.pages = function () { return [].concat(_this.Menu_page(), _this.Bord_page()); };
            });
        };
        $saprun_stuff_bord.prototype.body = function () {
            return [].concat(this.Dashbord());
        };
        $saprun_stuff_bord.prototype.foot = function () {
            return null;
        };
        return $saprun_stuff_bord;
    }($.$mol_page));
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord.prototype, "Head", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord.prototype, "Close_icon", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord.prototype, "Close", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord.prototype, "Menu", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord.prototype, "Menu_page", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord.prototype, "Bord", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord.prototype, "Bord_page", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord.prototype, "Dashbord", null);
    $.$saprun_stuff_bord = $saprun_stuff_bord;
})($ || ($ = {}));
(function ($) {
    var $saprun_stuff_bord_head = (function (_super) {
        __extends($saprun_stuff_bord_head, _super);
        function $saprun_stuff_bord_head() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        $saprun_stuff_bord_head.prototype.Logo_start_page = function () {
            return new $.$mol_image().setup(function (obj) {
                obj.uri = function () { return "-/saprun/stuff/thumbs/logokp.png"; };
            });
        };
        $saprun_stuff_bord_head.prototype.events = function () {
            return "События";
        };
        $saprun_stuff_bord_head.prototype.Link1 = function () {
            var _this = this;
            return new $.$mol_link().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.events()); };
            });
        };
        $saprun_stuff_bord_head.prototype.submit_label = function () {
            return "2";
        };
        $saprun_stuff_bord_head.prototype.Evens = function () {
            var _this = this;
            return new $.$mol_button_danger().setup(function (obj) {
                obj.title = function () { return _this.submit_label(); };
            });
        };
        $saprun_stuff_bord_head.prototype.help = function () {
            return "Тех.поддержка";
        };
        $saprun_stuff_bord_head.prototype.Link2 = function () {
            var _this = this;
            return new $.$mol_link().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.help()); };
            });
        };
        $saprun_stuff_bord_head.prototype.Add = function () {
            return "Еще";
        };
        $saprun_stuff_bord_head.prototype.Link3 = function () {
            var _this = this;
            return new $.$mol_link().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.Add()); };
            });
        };
        $saprun_stuff_bord_head.prototype.Menu = function () {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.Link1(), _this.Evens(), _this.Link2(), _this.Link3()); };
            });
        };
        $saprun_stuff_bord_head.prototype.close_title = function () {
            return "Выход";
        };
        $saprun_stuff_bord_head.prototype.Exit = function () {
            var _this = this;
            return new $.$mol_link().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.close_title()); };
            });
        };
        $saprun_stuff_bord_head.prototype.sub = function () {
            return [].concat(this.Logo_start_page(), this.Menu(), this.Exit());
        };
        return $saprun_stuff_bord_head;
    }($.$mol_view));
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord_head.prototype, "Logo_start_page", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord_head.prototype, "Link1", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord_head.prototype, "Evens", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord_head.prototype, "Link2", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord_head.prototype, "Link3", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord_head.prototype, "Menu", null);
    __decorate([
        $.$mol_mem()
    ], $saprun_stuff_bord_head.prototype, "Exit", null);
    $.$saprun_stuff_bord_head = $saprun_stuff_bord_head;
})($ || ($ = {}));
//bord.view.tree.js.map
;
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
(function ($) {
    ...
    (function ($mol) {
        ...
        $mol.$saprun_stuff_bord = $saprun_stuff_bord;
    })($mol = $.$mol || ($.$mol = {}));
})($ || ($ = {}));
//bord.view.js.map
