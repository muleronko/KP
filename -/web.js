...
var $;
(function ($) {
    var $my_kp = (function (_super) {
        __extends($my_kp, _super);
        function $my_kp() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        $my_kp.prototype.Logo_start_page = function () {
            return new $.$mol_image().setup(function (obj) {
                obj.uri = function () { return "-/my/kp/thumbs/logotextmini.svg"; };
            });
        };
        $my_kp.prototype.Menu = function () {
            return new $.$mol_view();
        };
        $my_kp.prototype.close_title = function () {
            return "Войти";
        };
        $my_kp.prototype.Exit = function () {
            var _this = this;
        ...
        $my_kp.prototype.Header = function () {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.Logo_start_page(), _this.Menu(), _this.Exit()); };
            });
        };
        $my_kp.prototype.head = function () {
            return [].concat(this.Header());
        };
        $my_kp.prototype.Logo_main = function () {
            return new $.$mol_image().setup(function (obj) {
                obj.uri = function () { return "-/my/kp/thumbs/logomain.svg"; };
            });
        };
        $my_kp.prototype.table_id_label = function () {
            return $.$mol_locale.text(this.locale_contexts(), "table_id_label");
        };
        $my_kp.prototype.table_id_errors = function () {
            return [];
        };
        $my_kp.prototype.table_id_hint = function () {
            return "231456";
        };
        $my_kp.prototype.table_id = function (val, force) {
            return (val !== void 0) ? val : "";
        };
        $my_kp.prototype.Table_id_control = function () {
            var _this = this;
        ...
        $my_kp.prototype.Table_id = function () {
            var _this = this;
        ...
        $my_kp.prototype.password_label = function () {
            return $.$mol_locale.text(this.locale_contexts(), "password_label");
        };
        $my_kp.prototype.password_errors = function () {
            return [];
        };
        $my_kp.prototype.password_hint = function () {
            return "******";
        };
        $my_kp.prototype.password = function (val, force) {
            return (val !== void 0) ? val : "";
        };
        $my_kp.prototype.password_control = function () {
            var _this = this;
            return new $.$mol_string().setup(function (obj) {
        ...
        $my_kp.prototype.Password = function () {
            var _this = this;
            return new $.$mol_form_field().setup(function (obj) {
        ...
        $my_kp.prototype.login_submit_label = function () {
            return $.$mol_locale.text(this.locale_contexts(), "login_submit_label");
        };
        $my_kp.prototype.event_submit = function (val, force) {
            return (val !== void 0) ? val : null;
        };
        $my_kp.prototype.Login_submit = function () {
            var _this = this;
        ...
        $my_kp.prototype.Sign_up_form = function () {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.Form()); };
            });
        };
        $my_kp.prototype.Form_box = function () {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.Logo_main(), _this.Sign_up_form()); };
            });
        };
        $my_kp.prototype.body = function () {
            return [].concat(this.Form_box());
        };
        $my_kp.prototype.Logo_lo = function () {
            return new $.$mol_image().setup(function (obj) {
                obj.uri = function () { return "-/my/kp/thumbs/logolo.svg"; };
            });
        };
        $my_kp.prototype.phone = function () {
            return "Тех.поддержка:\n8(812) 456-11-00";
        };
        $my_kp.prototype.Box_phone = function () {
            var _this = this;
            return new $.$mol_text().setup(function (obj) {
                obj.text = function () { return _this.phone(); };
            });
        };
        $my_kp.prototype.help = function () {
            return "[Получить / восстановить доступ](#)\n[Инструкция по работе с порталом](#)";
        };
        $my_kp.prototype.Box_link_help = function () {
            var _this = this;
            return new $.$mol_text().setup(function (obj) {
                obj.text = function () { return _this.help(); };
            });
        };
        $my_kp.prototype.web = function () {
            return "[Официальный сайт Администрации ЛО](http://lenobl.ru/)\n[Официальный сайт ГосУслуг](https://www.gosuslugi.ru/)";
        };
        $my_kp.prototype.Box_link_web = function () {
            var _this = this;
            return new $.$mol_text().setup(function (obj) {
                obj.text = function () { return _this.web(); };
            });
        };
        $my_kp.prototype.Footer = function () {
            var _this = this;
            return new $.$mol_view().setup(function (obj) {
                obj.sub = function () { return [].concat(_this.Logo_lo(), _this.Box_phone(), _this.Box_link_help(), _this.Box_link_web()); };
            });
        };
        $my_kp.prototype.foot = function () {
    ...
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Logo_start_page", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Menu", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Exit", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Header", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Logo_main", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "table_id", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Table_id_control", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Table_id", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "password", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "password_control", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Password", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "event_submit", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Login_submit", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Form", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Sign_up_form", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Form_box", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Logo_lo", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Box_phone", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Box_link_help", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Box_link_web", null);
    __decorate([
        $.$mol_mem()
    ], $my_kp.prototype, "Footer", null);
    $.$my_kp = $my_kp;
})($ || ($ = {}));
//kp.view.tree.js.map
;
